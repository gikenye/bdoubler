 ...
 */
export const APP_NAME: string = 'bdoubling';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'turn group focus sessions into a cooperative game powered by staking';
 ...
 */
export const APP_TAGS: string[] = ['games', 'exercise', 'playwithfriends', 'healthy', 'concentration', 'doubling', 'adhd', 'body'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'double';
