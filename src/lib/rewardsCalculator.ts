...
const mockGroups: MockGroup[] = [
  {
    id: 'group1',
    stakeAmount: 1000000000000000000n, // 1 ETH in wei
    totalCollected: 5000000000000000000n, // 5 ETH
    totalCompleted: 3n,
    participants: [
  ...
  {
    id: 'group2',
    stakeAmount: 2000000000000000000n, // 2 ETH
    totalCollected: 6000000000000000000n, // 6 ETH
    totalCompleted: 2n,
    participants: [
...
// Convert bigint to number for calculations (assuming ETH, divide by 10^18)
...
export function calculateGroupRewards(groupId: string): {
  participants: { userId: string; stakeReturn: number; bonus: number; total: number }[];
} {
